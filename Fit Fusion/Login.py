...
class LoginSignupApp(QWidget):
    ...
    def show_login_window(self):
        """Show login window with enhanced interaction"""
        ...
        self.login_email.setStyleSheet("font-size: 25px; padding: 10px; border-radius: 5px;")
        ...
        self.login_password.setStyleSheet("font-size: 25px; padding: 10px; border-radius: 5px;")
        self.login_password.setEchoMode(QLineEdit.Password)
        self.login_password.setPlaceholderText("Enter your password")
        layout.addWidget(self.login_password)

        # Forgot Password Link (opens a dialog or shows a message)
        forgot_password_link = QLabel('<a href="#">Forgot Password?</a>', self)
        forgot_password_link.setStyleSheet("font-size: 20px; color: #2196F3;")
